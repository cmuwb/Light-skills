...
- [2026-06-06] 数据起步策略：CherryChèvre(CC许可,可下载)做检测预训练 + AP-10K/APT-36K 做姿态迁移 + 自建行为标注 — 无奶山羊"姿态+ID+多场景+行为"综合公开基准；GoatABRD/DiaryGoatMVT 许可未声明不能做可再分发基线 — 来源 m02 + db04 cards_animal_livestock.md
...
- [2026-06-06] 投稿首选 Computers and Electronics in Agriculture(venues.csv 第140行)，会议关注 CV4Animals — 应用型家畜 CV 工作主场；该刊本方向 h_index=220、2yr均被引9.19 — 来源 m01/m13 + db01 venues.csv

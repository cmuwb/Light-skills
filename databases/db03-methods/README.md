...
- [cards_mining_other.md](cards_mining_other.md) — 数据挖掘/图/时序/推荐/优化（18 卡）
- [cards_frontier.md](cards_frontier.md) — 前沿/新兴方法（自监督/MAE/LLM Agent/Mamba/多模态大模型/NeRF/3DGS 等，25 卡，代表作 OpenAlex 实拉；RAG canonical 见 cards_nlp_speech.md）

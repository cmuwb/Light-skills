...
- CI 工作流:校验所有技能的 `SKILL.md` frontmatter,并编译校验 `code_assets/` 脚本。

### Changed
- 重写中英双语 README,按"17 手动 / 10 常驻"重组技能总览。

## [1.0.0] - 2026-06

### Added
- 27 个技能,覆盖科研全流程:文献调研 → 数据 → 创新 → 方案 → 实验 → 分析 → 写作润色 → 图表 → 排版 → 投稿 → 返修 → 软著专利 → PPT → 竞赛。
  ...
  - **10 个常驻技能**(后台自动):file-reading、memory-pm、backend-coding、system-design、frontend-design、project-structure、consistency、self-review、tool-selection、research-ethics。
